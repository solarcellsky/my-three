...
export default {
  ...
  methods: {
    ...
    initCesium() {
      const dataJSON = './assets/data-sh.json';
        ...
        .then(function (response) {
          ...
          mapbox: {
              ...
              light: {
                  ...
                  ambientCubemap: {
                      texture: './assets/data-1491896094618-H1DmP-5px.hdr',
                      exposure: 1,
    ...
    init() {
      ...
      shapefile.open('./assets/data-1498751177695-rkzAeiGEb.shp', './assets/data-1498751184605-rJYAxjMVW.dbf')
      ...
      axios.get('/assets/data-1498751206824-HkkgZsfEW.json')
        .then((response) => {
